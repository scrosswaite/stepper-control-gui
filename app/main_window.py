...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.is_busy = False
        self._load_settings() # This now defines the default mechanical params
        ...
        # Build the UI from main_ui.py
        setup_ui(self)
        
        # Update the UI fields in the "Settings" tab with loaded values
    ...
    def _lock_ui(self, message="Busy..."):
        ...
        for btn in (
            self.dunk_btn, self.zero_btn, self.calib_btn, self.up_btn, 
            self.down_btn, self.connect_btn, self.begin_lvl_btn,
            self.settings_btn, self.apply_settings_btn
        ):
    ...
    def _send_up(self):
        ...
        self.serial.send(f"MOVE {self._click_deg}\n")
    ...
    def _send_estop(self):
        ...
        self._unlock_ui("E-STOP Sent.") # Unlock immediately for E-Stop

    # --- Config and Settings Methods ---
    def _load_settings(self):
        ...
        self._comp_factor = 300 / 9.35 # This remains hardcoded
